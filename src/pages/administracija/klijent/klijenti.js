        ...
        this.datasource = new kendo.data.DataSource({
            ...
            schema: {
                ...
                model: {
                    id: "id",
                    fields: {
                        ugovoreno: { type: 'number' },
                        fakturisano: { type: 'number' },
                        uplaceno: { type: 'number' }
                        //uloga: { type: 'string' }
                    }
                }
            }
            ,aggregate: [
                { field: "ugovoreno", aggregate: "sum" },
                { field: "fakturisano", aggregate: "sum" },
                { field: "uplaceno", aggregate: "sum" }
            ]
        });
    }
    izmena(obj, e) {

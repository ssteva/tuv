...
import { KlijentEntity } from './entiteti/klijent';
import { KorisnikEntity } from './entiteti/korisnik';
import { KontaktEntity } from './entiteti/kontakt';
import { PrimarnaEntity } from './entiteti/primarna';
import { SekundarnaEntity } from './entiteti/sekundarna';
import { TercijarnaEntity } from './entiteti/tercijarna';
import { ObimEntity } from './entiteti/obim';
import { FinansijeEntity } from './entiteti/finansije';
...
export function configure(aurelia) {
    ...
    aurelia.use
                ...
                config
                    ...
                    .registerEndpoint('fajl2',
                        configure => {
                            ...
                            //configure.withResponseType('blob')
                            configure.withInterceptor({
                                request(request) {
                                    let ac = aurelia.container.get(AltairCommon);
                                    //toastr.success(`Requesting ${request.method} ${request.url}`);
                                ...
                                response(response) {
                                    ...
                                    var blob = response.blob()
                                        .then(blob => {
                                            download.default(blob, 'PonudaStampa.docx', 'application/octet-stream');
        ...
        .plugin('aurelia-orm',
            builder => {
                //builder.registerEntities(entiteti.KorisnikEntity, entiteti.KlijentEntity, entiteti.KontaktEntity, entiteti.PrimarnaEntity, entiteti.SekundarnaEntity, entiteti.TercijarnaEntity, entiteti.ObimEntity, entiteti.FinansijeEntity
                builder.registerEntities(KorisnikEntity, KlijentEntity, KontaktEntity, PrimarnaEntity, SekundarnaEntity, TercijarnaEntity, ObimEntity, FinansijeEntity)

...
export var alt=  {
    ...
    altair_page_onload:altair_page_onload,

    // main header
    //altair_main_header.init();
    altair_main_header:altair_main_header,

    // main sidebar
    //altair_main_sidebar.init();
    altair_main_sidebar:altair_main_sidebar,
    // secondary sidebar
    //altair_secondary_sidebar.init();
    altair_secondary_sidebar:altair_secondary_sidebar,

    // top bar
    //altair_top_bar.init();
    altair_top_bar:altair_top_bar,

    // page heading
    //altair_page_heading.init();
    altair_page_heading:altair_page_heading,
    ...
    // forms
    //altair_forms.init();
    altair_forms: altair_forms,

    altair_helpers: altair_helpers
...
altair_main_header = {
    init: () => {
        this.altair_main_header.search_activate();
        this.altair_main_header.search_autocomplete();
    },
    search_activate: () => {
        ...
        if(this.$body.hasClass('main_search_persistent')) {
            this.altair_main_header.search_show();
        }
    },
